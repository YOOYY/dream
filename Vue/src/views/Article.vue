<template>
    <div id="article">
        <v-headpanel>
            <em>文章信息更换</em>文章内图片尺寸宽度1200px,资讯缩略图尺寸275*150px,活动缩略图尺寸为590*200px,建议用tinypng压缩,没有英文内容的情况下会用中文内容代替,时间格式为 2020-04-02 20:39:42,权重和阅读量请填写数字。
        </v-headpanel>
        ...
        >
            ...
            >
                ...
                <el-form-item
                    ...
                    prop="title_en"
                >
                    <el-input v-model.trim="form.title_en"></el-input>
                </el-form-item>
                <el-form-item
                    label="描述"
                    label-width="100px"
                ...
                <el-form-item
                    ...
                    prop="des_en"
                >
                    <el-input v-model.trim="form.des_en"></el-input>
                </el-form-item>
                <el-form-item
                    label="阅读量"
                    label-width="100px"
