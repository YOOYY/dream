...
<div id="news_article">
      ...
      <div class="container">
        <div class="time"> <?php echo $this->info['time'] ?> <?php echo $this->translate->_("newsReader");echo $this->info['reader'] ?></div>
        <div class="content">
            <?php
        ...
        <?php
          if($this->prev){
            ...
            echo '<li><a href="/news/news/id/'.$this->prev['id'].'">'.$this->translate->_("newsPre").' | '.$prevtitle.'</a></li>';
          }
          if($this->next){
            ...
            echo '<li><a href="/news/news/id/'.$this->next['id'].'">'.$this->translate->_("newsNext").' | '.$nexttitle.'</a></li>';
          }
          ?>
        </ol>
      </div>
